...
ウェブ上で見つかる絵の具やペンキの色のデータ（PANTONEやDICなど特色インクを除く）を１００００色以上寄せ集めたスウォッチを作成しました。実用的ではありません

### NAZO-RGB.gpl

拙作のPHPスクリプトで、CIE-LABのパレットの色でNAZO-COLORSのデータを調べ、似ている実在する色を探して置き換えたスウォッチです。RGBの差分とHSVのHの差分で似ているデータを調べてます
...
色のスウォッチをダウンロード出来るウェブです。フリーウェアを使って、Gimpなどで使えるgplファイルへコンバート出来ます
